...
import NewDestinationForm from './NewDesitnationForm';
...
function App() {
  ...
  const [destinations, setDestinations] = useState([])  //state that represents currently available destinations, including added ones
